        ...
        <form class="needs-validation" novalidate @submit="submitForm" id="login-form" method="post">
            <div class="form-row form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="phone" placeholder="手机号" v-model.trim="user.phone" required>
...
export default {
    ...
    methods: {
        submitForm() {
            ...
            if (this.errors.user.phone || this.errors.user.password) return false
            apiService
