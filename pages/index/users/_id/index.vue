<template>
  <div class="row">
    ...
    <div class="col-md-9">
      <div class="border bg-white mb-4">
        <div class="border-bottom text-center p-2 font-red">
          <svg
            ...
            data-prefix="fas"
            data-icon="book-open"
            class="svg-inline--fa fa-book-open fa-w-18 mr-2"
            role="img"
        ...
        >
          <div class="col-md-11">
            <a class="text-muted" target="_blank" :href="'/posts/' + post.id"
      ...
      <div class="border bg-white mb-4">
        <div class="border-bottom text-center p-2 font-red">
          <svg
            ...
            class="mr-2 svg-inline--fa fa-comment-dots fa-w-16"
            role="img"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
          >
      ...
      <no-ssr>
        <div v-if="user.id == $route.params.id" class="border bg-white mb-4">
          <div class="border-bottom text-center p-2 font-red">
            <svg
              height="18"
              width="18"
              ...
              data-prefix="fas"
              data-icon="box-open"
              class="mr-2 svg-inline--fa fa-box-open fa-w-20"
              role="img"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 640 512"
            >
