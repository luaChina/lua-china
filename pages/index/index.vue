    ...
    <div class="row">
      <div class="col-lg-9 col-12 mb-4 px-lg-3 p-0">
        ...
        <ul class="pagination justify-content-center">
          ...
          <li
            :class="pageActive === item ? 'page-item active' : 'page-item'"
            v-for="item in pageNum"
          >
            <a class="page-link" @click="getPosts(item)" href="#">{{ item }}</a>
          </li>
      ...
      <div class="col p-0">
              ...
              >
                <div>
                  <hash-avatar
                    ...
                    class="rounded-circle mr-2"
                  ></hash-avatar>
                  <router-link class="font-red" :to="'/users/' + user.id">{{
                    user.name
                  }}</router-link>
                </div>
        ...
        <div class="bg-white border">
          ...
          <div class="ps-4 pe-4 announcement-content  text-muted">
