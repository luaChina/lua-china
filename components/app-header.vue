      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item mr-2">
            <router-link class="nav-link" to="/" active-class="active" exact rel="nofollow">文章</router-link>
          </li>
          <!-- <li class="nav-item mr-2">
            <router-link class="nav-link" to="/posts?category=lua_base" rel="nofollow">Lua基础</router-link>
          </li> -->
          <li class="nav-item mr-2">
            <a class="nav-link" href="https://www.github.com/horan-geeker/nana" target="_black" rel="nofollow">Nana</a>
          </li>
          <li class="nav-item mr-2">
            <a class="nav-link" href="https://konghq.com/" target="_black" rel="nofollow">Kong</a>
          </li>
        </ul>
          ...
          <div>
            ...
            <div class="d-flex align-items-center" v-if="auth.id!=0">
              <a href="/posts/create" target="_blank" role="button">
                <router-link :to="'/posts/create'" class="btn btn-outline-danger btn-sm mr-2" rel="nofollow">发布文章</router-link>
              </a>
              <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                  ...
                  <a href="#" class="dropdown-item text-danger" data-toggle="modal" data-target="#logoutModal" rel="nofollow">
